...
/**
 * This class provides a wrapper for network errors when making requests to Klarna Checkout API V3
 */
export class KlarnaCheckoutError extends Error {
  /**
   * The response body
   */
